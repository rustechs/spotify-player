...
pub enum Command {
    ...
    TopTrackPage,
    ShortTermTopTrackPage,
    LongTermTopTrackPage,
...
impl Command {
    pub fn desc(self) -> String {
        ...
        match self {
            ...
            Self::TopTrackPage => "go to the user top track page (~6 months)",
            Self::ShortTermTopTrackPage => "go to the user top track page (~4 weeks)",
            Self::LongTermTopTrackPage => "go to the user top track page (~1 year)",
